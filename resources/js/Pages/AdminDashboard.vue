      ...
      <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
          ...
          >
            ...
            <td class="px-6 py-4">Ribeira da Prata</td>
            <td class="px-6 py-4">9379687</td>
            <td class="px-6 py-4 text-right">
              <div class="flex justify-end">
                ...
                <a
                  href="#"
                  class="font-medium text-red-600 dark:text-red-500 hover:underline pr-1"
                  ><svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-6 w-6"
                    fill="none"
          ...
          >
            ...
            <td class="px-6 py-4">Chão Bom</td>
            <td class="px-6 py-4">9783322</td>
            <td class="px-6 py-4 text-right">
              <div class="flex justify-end">
                <a
                  href="#"
          ...
          >
            ...
            <td class="px-6 py-4">Vila</td>
            <td class="px-6 py-4">9873622</td>
            <td class="px-6 py-4 text-right">
              <div class="flex justify-end">
                <a
                  href="#"
          ...
          >
            ...
            <td class="px-6 py-4">Achada Tenda</td>
            <td class="px-6 py-4">9762527</td>
            <td class="px-6 py-4 text-right">
              <div class="flex justify-end">
                <a
                  href="#"
